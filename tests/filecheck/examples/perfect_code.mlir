...
// CHECK-NEXT:   qref.gate<#gate.cnot> %a4, %q2
// CHECK-NEXT:   qref.gate<#gate.cnot> %a4, %q4
...
// CHECK-NEXT:   qref.dyn_gate<%cor1x_sel> %q1 : !qubit.bit
// CHECK-NEXT:   %cor1z = arith.andi %cor1, %s1 : i1
// CHECK-NEXT:   %cor1z_sel = arith.select %cor1z, %z, %id : !gate.type<1>
// CHECK-NEXT:   qref.dyn_gate<%cor1z_sel> %q1 : !qubit.bit
...
// CHECK-NEXT:   qref.dyn_gate<%cor2x_sel> %q2 : !qubit.bit
// CHECK-NEXT:   %cor2z = arith.andi %cor2, %s2 : i1
// CHECK-NEXT:   %cor2z_sel = arith.select %cor2z, %z, %id : !gate.type<1>
// CHECK-NEXT:   qref.dyn_gate<%cor2z_sel> %q2 : !qubit.bit
...
// CHECK-NEXT:   qref.dyn_gate<%cor3x_sel> %q3 : !qubit.bit
// CHECK-NEXT:   %cor3z = arith.andi %cor3, %s3 : i1
// CHECK-NEXT:   %cor3z_sel = arith.select %cor3z, %z, %id : !gate.type<1>
// CHECK-NEXT:   qref.dyn_gate<%cor3z_sel> %q3 : !qubit.bit
...
// CHECK-NEXT:   qref.dyn_gate<%cor4x_sel> %q4 : !qubit.bit
// CHECK-NEXT:   %cor4z = arith.andi %cor4, %s1 : i1
// CHECK-NEXT:   %cor4z_sel = arith.select %cor4z, %z, %id : !gate.type<1>
// CHECK-NEXT:   qref.dyn_gate<%cor4z_sel> %q4 : !qubit.bit
...
// CHECK-NEXT:   qref.gate<#gate.cnot> %a4_1, %q2
// CHECK-NEXT:   qref.gate<#gate.cnot> %a4_1, %q4
...
func.func @perfect_code(%q1: !qubit.bit, %q2: !qubit.bit, %q3: !qubit.bit, %q4: !qubit.bit, %q5: !qubit.bit) {
  ...
  qref.gate<#gate.cnot> %a4, %q2
  qref.gate<#gate.cnot> %a4, %q4
  ...
  qref.dyn_gate<%cor1x_sel> %q1 : !qubit.bit

  %cor1z = arith.andi %cor1, %s1 : i1
  %cor1z_sel = arith.select %cor1z, %z, %id : !gate.type<1>
  qref.dyn_gate<%cor1z_sel> %q1 : !qubit.bit
  ...
  qref.dyn_gate<%cor2x_sel> %q2 : !qubit.bit

  %cor2z = arith.andi %cor2, %s2 : i1
  %cor2z_sel = arith.select %cor2z, %z, %id : !gate.type<1>
  qref.dyn_gate<%cor2z_sel> %q2 : !qubit.bit
  ...
  qref.dyn_gate<%cor3x_sel> %q3 : !qubit.bit

  %cor3z = arith.andi %cor3, %s3 : i1
  %cor3z_sel = arith.select %cor3z, %z, %id : !gate.type<1>
  qref.dyn_gate<%cor3z_sel> %q3 : !qubit.bit
  ...
  qref.dyn_gate<%cor4x_sel> %q4 : !qubit.bit

  %cor4z = arith.andi %cor4, %s1 : i1
  %cor4z_sel = arith.select %cor4z, %z, %id : !gate.type<1>
  qref.dyn_gate<%cor4z_sel> %q4 : !qubit.bit
  ...
  qref.gate<#gate.cnot> %a4_1, %q2
  qref.gate<#gate.cnot> %a4_1, %q4
